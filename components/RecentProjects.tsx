        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            ...
            <PinContainer title={link} href={link}>
              <Link href={link}>
                <div className="relative flex items-center justify-center sm:w-[570px] sm:h-[40vh] w-[80vw] h-[30vh] overflow-hidden mb-10">
                ...
                <div className="flex items-center justify-between mt-7 mb-3">
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    <FaLocationArrow className="ms-3" color="#a3e635" />
                  </div>
                </div>
              </Link>
            </PinContainer>
